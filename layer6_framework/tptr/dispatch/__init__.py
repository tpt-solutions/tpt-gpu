...
class DispatchRegistry:
    ...
    def register_custom(self, name, factory, op_type=OpType.CUSTOM, **kwargs):
...
def register_op(name, op_type=OpType.CUSTOM, **kwargs):
...
def dispatch_op(name, *args, **kwargs):
