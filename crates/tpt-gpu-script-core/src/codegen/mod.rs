...
"#,
        ...
        assert!(
            out.rust_source.contains("host_fn"),
            "rust_source: {}",
            out.rust_source
        );
        assert!(
            out.rust_source.contains("GPU kernel `kernel`"),
            "rust_source: {}",
            out.rust_source
        );
        assert!(
            out.tptir_source.contains("func @kernel"),
            "tptir_source: {}",
            out.tptir_source
        );
        assert!(
            !out.tptir_source.contains("host_fn"),
            "tptir should not contain host_fn"
        );
    }
